...
// none
// mylat = 40.75763256906193;
// mylong = -73.95427918045978;
...
if (mylat<40.737355 && mylat>40.736744 && mylong>-73.992523 && mylong<-73.991551) { 
...
if (mylat>40.734923 && mylat<40.735505 && mylong>-73.994956&& mylong<-73.994159) { 
...
if (mylat<40.737004 && mylat>40.736226&& mylong>-73.996773&& mylong< -73.995970) { 
...
$(".tag_3").css({"display": "block"});
$(".tag_3").css({"left": "-22%"});
$(".tag_3").append("4. Making Center 5Ave <br /> 6.Mannes School of Music");
...
$(".arrow_1").css({"display": "block"});
$(".tag_1").css({"display": "block"});
$(".tag_1").append("Mannes School of Music");
